...
def import_cams():
    ...
    for c in cams:
        ...
        rtsp_url = f"rtsp://pishundhameliya%40gmail.com:2PRZ-MGZQ-3REF@103.250.160.189:8554/stream/cam{int(c['id']):02d}"
        live_url = ""
        spot = c.get('location', '')
        ...
        cur.execute(
            """INSERT OR REPLACE INTO cameras 
               ...
               VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)""",
            (
                cid, name, city_id.title(), lat, lng, rtsp_url, "live", "ready",
