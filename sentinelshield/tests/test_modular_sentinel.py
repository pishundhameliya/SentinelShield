...
from sentinelshield.core.state import live_stream_state, ai_state, tracking_state
from sentinelshield.modules.integrity.hash_chain import HashChainManager, sha256_bytes
...
from sentinelshield.modules.vision.alpr_ocr import normalize_plate, extract_plates_from_text, detect_fast_alpr
from sentinelshield.modules.vision.service import vision_service
from sentinelshield.modules.tracking.tracker import CentroidVehicleTracker
from sentinelshield.modules.alerts.fusion import translate_alert, LANG
