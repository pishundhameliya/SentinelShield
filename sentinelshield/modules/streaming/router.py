...
from sentinelshield.core.state import ai_state, live_stream_state
from sentinelshield.modules.registry.estate_data import total_cameras
from sentinelshield.modules.streaming.service import streaming_service
